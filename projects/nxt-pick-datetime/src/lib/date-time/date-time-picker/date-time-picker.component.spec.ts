...
import { createKeyboardEvent, dispatchFakeEvent, dispatchKeyboardEvent, dispatchMouseEvent, OwlTestDateTimeModule } from '../../../test-helpers'
...
describe('OwlDateTimeComponent', () => {
    ...
    describe('with OwlTestDateTimeModule', () => {
