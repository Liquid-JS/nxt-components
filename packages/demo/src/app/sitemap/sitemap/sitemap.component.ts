...
export class AppSitemapComponent {
    ...
    readonly runnBuilder = 'ng run project:sitemap'

    readonly builderConfig = `{
    "build": { 
        "..."
    },
    "sitemap": {
    ...
    readonly trailingSlash = `import { DefaultUrlSerializer, UrlSerializer, UrlTree } from '@angular/router'
