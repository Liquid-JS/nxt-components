import"./chunk-F5DYP4RK.js";var i=`<input class="form-control"\r
    [class.is-invalid]="minDateTimeControl.invalid"\r
    [(ngModel)]="value"\r
...
<input class="form-control"\r
    [class.is-invalid]="maxDateTimeControl.invalid"\r
    [(ngModel)]="value"\r
