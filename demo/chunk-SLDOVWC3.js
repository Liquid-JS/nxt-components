...
`,line:25,rawdescription:"\nInitial number of levels to be expanded; to expand / collapse the view after initial render, use `expandTo` / `collapseTo`",modifierKind:[148],required:!1}],outputsClass:[],propertiesClass:[{name:"_levelOpen",defaultValue:`linkedSignal({\r
        source: () => this.levelOpen(),\r
        computation: level => level\r
    })`,deprecated:!1,deprecationMessage:"",type:"",indexKey:"",optional:!1,description:"",line:26,modifierKind:[148]}],methodsClass:[{name:"collapseTo",args:[{name:"level",type:"number",deprecated:!1,deprecationMessage:""}],optional:!1,returnType:"void",typeParameters:[],line:49,deprecated:!1,deprecationMessage:"",rawdescription:`
Collapse any open items above the given level`,description:`<p>Collapse any open items above the given level</p>
`,jsdoctags:[{name:"level",type:"number",deprecated:!1,deprecationMessage:"",tagName:{text:"param"}}]},{name:"expandTo",args:[{name:"level",type:"number",deprecated:!1,deprecationMessage:""}],optional:!1,returnType:"void",typeParameters:[],line:43,deprecated:!1,deprecationMessage:"",rawdescription:`
Expand all items up to the given level`,description:`<p>Expand all items up to the given level</p>
`,jsdoctags:[{name:"level",type:"number",deprecated:!1,deprecationMessage:"",tagName:{text:"param"}}]},{name:"ngAfterViewChecked",args:[],optional:!1,returnType:"void",typeParameters:[],line:35,deprecated:!1,deprecationMessage:""}],deprecated:!1,deprecationMessage:"",hostBindings:[],hostListeners:[],standalone:!1,imports:[{name:"JsonViewItemComponent",type:"component"}],description:"",rawdescription:`
`,type:"component",assetsDirs:[],extends:[],implements:["AfterViewChecked"]}],modules:[{name:"JsonViewModule",id:"module-JsonViewModule-b2d29f6b5d522b069dfae164dcb7673534c6d23bd515465cbe52ed45d17105a37774415f1ce2ba3400060f7a74e4c13594cdb3075b8d1d7bafd2f9fea12bb093",description:"",deprecationMessage:"use standalone imports",deprecated:!0,file:"src/lib/json-view.module.ts",methods:[],children:[{type:"providers",elements:[]},{type:"declarations",elements:[]},{type:"imports",elements:[{name:"JsonViewComponent"}]},{type:"exports",elements:[{name:"JsonViewComponent"}]},{type:"bootstrap",elements:[]},{type:"classes",elements:[]}]}],miscellaneous:[]};var w=()=>["shell"],y=()=>["typescript"],x=()=>["html"],E=(()=>{class d{constructor(l){this.title=l,this.installScript="npm install --save nxt-json-view",this.importComponent=`import { JsonViewComponent } from 'nxt-json-view'
...
@Component({
    ...
    "date": new Date(),
    "null": null
}`,this.includeHTML='<nxt-json-view [data]="data"></nxt-json-view>',this.componentDocs=v.components.find(e=>e.selector=="nxt-json-view"),this.inputs=this.componentDocs?.inputsClass.sort((e,a)=>e.line-a.line)??[]}ngOnInit(){this.title.setTitle("Getting started | nxt-json-view")}static{this.\u0275fac=function(e){return new(e||d)(c(f))}}static{this.\u0275cmp=m({type:d,selectors:[["app-getting-started"]],decls:22,vars:13,consts:[[1,"h4"],[3,"code","languages"],[1,"h3"],[3,"inputs"]],template:function(e,a){e&1&&(n(0,"app-content-wrap")(1,"h1"),i(2,"Getting started with nxt-json-view"),t(),n(3,"h2",0),i(4,"Installing"),t(),p(5,"app-code-block",1)(6,"br"),n(7,"h2",0),i(8,"Import JSON view component"),t(),p(9,"app-code-block",1)(10,"br"),n(11,"h2",0),i(12,"Prepare JSON data"),t(),p(13,"app-code-block",1)(14,"br"),n(15,"h2",0),i(16,"Use it in a template"),t(),p(17,"app-code-block",1)(18,"br"),n(19,"h2",2),i(20,"Configuration options"),t(),p(21,"app-inputs-table",3),t()),e&2&&(s(5),o("code",a.installScript)("languages",r(9,w)),s(4),o("code",a.importComponent)("languages",r(10,y)),s(4),o("code",a.data)("languages",r(11,y)),s(4),o("code",a.includeHTML)("languages",r(12,x)),s(4),o("inputs",a.inputs))},dependencies:[b,u,g],encapsulation:2})}}return d})();export{E as GettingStartedComponent};
