import"./chunk-FBFWB55K.js";var l=`<div class="row">\r
    <div class="col">\r
...
\r
        <div class="form-check form-switch">\r
            <input class="form-check-input"\r
                ...
                (ngModelChange)="type.set($event ? 'directive' : 'component')">\r
...
\r
        <div class="form-check form-switch">\r
            <input class="form-check-input"\r
                ...
                name="is-disabled"\r
                [ngModel]="disabled()"\r
                (ngModelChange)="disabled.set(!!$event)">\r
            <label class="form-check-label"\r
...
\r
        <div class="form-check form-switch">\r
            <input class="form-check-input"\r
                ...
                id="is-multiple"\r
                name="is-multiple"\r
                [ngModel]="maxFiles() != 1"\r
                (ngModelChange)="maxFiles.set($event ? undefined : 1)">\r
            <label class="form-check-label"\r
...
\r
        <div class="form-check form-switch">\r
            <input class="form-check-input"\r
                ...
                name="auto-reset"\r
                [ngModel]="autoReset()"\r
                (ngModelChange)="autoReset.set(!!$event)">\r
            <label class="form-check-label"\r
...
\r
        <div class="form-check form-switch">\r
            <input class="form-check-input"\r
                ...
                name="click-action"\r
                [ngModel]="clickable()"\r
                (ngModelChange)="clickable.set(!!$event)">\r
            <label class="form-check-label"\r
...
\r
    ...
    <div class="col demo-dz-column">\r
        ...
        <nxt-dropzone class="dropzone-container"\r
            ...
            (init)="onUploadInit($event)"\r
            (error)="onUploadError($event)"\r
            (success)="onUploadSuccess($event)" />\r
        }\r
\r
    </div>\r
</div>\r
